    ...
    return (
        <div className="h-full flex flex-col justify-center items-center select-none">
            ...
            <motion.div 
                ...
                className="mb-8"
            >
                <div className="text-6xl font-black tracking-tighter text-fg">
                    AURA
                </div>
            ...
            <nav className="flex gap-8">
                {[{name: "GitHub", href: "https://github.com/maxi-schaefer/aura"}].map((item) => (
                    <p
                        ...
                        className="text-[11px] uppercase tracking-widest text-gray-500 hover:text-fg transition-colors duration-300 relative group cursor-pointer"
                    >
                        {item.name}
